...
const DEFAULT_PLANS = [
  {
    ...
    description: "3 credits offerts a l'inscription. Aucune carte requise.",
    priceMonthly: 0, priceYearly: 0, currency: "EUR", credits: 3,
    featured: 0, enabled: 1, sortOrder: 0,
    whopPlanId: null, whopCheckoutUrl: null, billingPeriod: null,
    tier: "free", expiresDays: null,
  },
  {
    slug: "sub_starter",
    nameJson: JSON.stringify({ en: "Starter", fr: "Decouverte", es: "Inicio" }),
    description: "Abonnement mensuel - 30 credits/mois.",
    priceMonthly: 9.99, priceYearly: 9.99, currency: "EUR", credits: 30,
    featured: 0, enabled: 1, sortOrder: 1,
    ...
    tier: "subscription", expiresDays: 30,
  },
  {
    slug: "sub_creator",
    nameJson: JSON.stringify({ en: "Creator", fr: "Createur", es: "Creador" }),
    description: "Abonnement mensuel - 100 credits/mois.",
    priceMonthly: 24.99, priceYearly: 24.99, currency: "EUR", credits: 100,
    featured: 1, enabled: 1, sortOrder: 2,
  ...
  },
  {
    ...
    description: "Abonnement mensuel - 250 credits/mois.",
    priceMonthly: 49.99, priceYearly: 49.99, currency: "EUR", credits: 250,
    featured: 0, enabled: 1, sortOrder: 3,
  ...
  },
  {
    ...
    description: "Abonnement mensuel - 500 credits/mois.",
    priceMonthly: 99.99, priceYearly: 99.99, currency: "EUR", credits: 500,
    featured: 0, enabled: 1, sortOrder: 4,
  ...
  // === RECHARGES ONE_TIME (Phase 1 - 8 plans: 4 packs x 2 tiers) ===
  {
    slug: "recharge_small_normal",
    nameJson: JSON.stringify({ en: "Small", fr: "Petit", es: "Pequeno" }),
    description: "30 credits - tarif normal.",
    priceMonthly: 11.99, priceYearly: 11.99, currency: "EUR", credits: 30,
    featured: 0, enabled: 1, sortOrder: 100,
    whopPlanId: "plan_DPhvShsD3YBfX",
    whopCheckoutUrl: "https://whop.com/checkout/plan_DPhvShsD3YBfX",
    billingPeriod: "one_time",
    tier: "recharge_normal", expiresDays: null,
  },
  {
    slug: "recharge_small_subscriber",
    nameJson: JSON.stringify({ en: "Small (Subscriber)", fr: "Petit (Abonne)", es: "Pequeno (Suscriptor)" }),
    description: "30 credits - tarif abonne (-25%).",
    priceMonthly: 8.99, priceYearly: 8.99, currency: "EUR", credits: 30,
    featured: 0, enabled: 1, sortOrder: 101,
    whopPlanId: "plan_S46OB7PUueJb6",
    whopCheckoutUrl: "https://whop.com/checkout/plan_S46OB7PUueJb6",
    billingPeriod: "one_time",
    tier: "recharge_subscriber", expiresDays: 30,
  },
  {
    slug: "recharge_medium_normal",
    nameJson: JSON.stringify({ en: "Medium", fr: "Moyen", es: "Mediano" }),
    description: "75 credits - tarif normal.",
    priceMonthly: 23.99, priceYearly: 23.99, currency: "EUR", credits: 75,
    featured: 1, enabled: 1, sortOrder: 102,
    whopPlanId: "plan_CtGtFRboRby5g",
    whopCheckoutUrl: "https://whop.com/checkout/plan_CtGtFRboRby5g",
    billingPeriod: "one_time",
    tier: "recharge_normal", expiresDays: null,
  },
  {
    slug: "recharge_medium_subscriber",
    nameJson: JSON.stringify({ en: "Medium (Subscriber)", fr: "Moyen (Abonne)", es: "Mediano (Suscriptor)" }),
    description: "75 credits - tarif abonne (-25%).",
    priceMonthly: 17.99, priceYearly: 17.99, currency: "EUR", credits: 75,
    featured: 0, enabled: 1, sortOrder: 103,
    whopPlanId: "plan_ArkwvItVX8gRs",
    whopCheckoutUrl: "https://whop.com/checkout/plan_ArkwvItVX8gRs",
    billingPeriod: "one_time",
    tier: "recharge_subscriber", expiresDays: 30,
  },
  {
    slug: "recharge_large_normal",
    nameJson: JSON.stringify({ en: "Large", fr: "Grand", es: "Grande" }),
    description: "200 credits - tarif normal.",
    priceMonthly: 47.99, priceYearly: 47.99, currency: "EUR", credits: 200,
    featured: 0, enabled: 1, sortOrder: 104,
    whopPlanId: "plan_15tQouA3OI2l2",
    whopCheckoutUrl: "https://whop.com/checkout/plan_15tQouA3OI2l2",
    billingPeriod: "one_time",
    tier: "recharge_normal", expiresDays: null,
  },
  {
    slug: "recharge_large_subscriber",
    nameJson: JSON.stringify({ en: "Large (Subscriber)", fr: "Grand (Abonne)", es: "Grande (Suscriptor)" }),
    description: "200 credits - tarif abonne (-25%).",
    priceMonthly: 35.99, priceYearly: 35.99, currency: "EUR", credits: 200,
    featured: 0, enabled: 1, sortOrder: 105,
    whopPlanId: "plan_rBb0iTfLMgRrb",
    whopCheckoutUrl: "https://whop.com/checkout/plan_rBb0iTfLMgRrb",
    billingPeriod: "one_time",
    tier: "recharge_subscriber", expiresDays: 30,
  },
  {
    slug: "recharge_xl_normal",
    nameJson: JSON.stringify({ en: "XL", fr: "XL", es: "XL" }),
    description: "500 credits - tarif normal.",
    priceMonthly: 119.99, priceYearly: 119.99, currency: "EUR", credits: 500,
    featured: 0, enabled: 1, sortOrder: 106,
    whopPlanId: "plan_wCszM2Z7PjWix",
    whopCheckoutUrl: "https://whop.com/checkout/plan_wCszM2Z7PjWix",
    billingPeriod: "one_time",
    tier: "recharge_normal", expiresDays: null,
  },
  {
    slug: "recharge_xl_subscriber",
    nameJson: JSON.stringify({ en: "XL (Subscriber)", fr: "XL (Abonne)", es: "XL (Suscriptor)" }),
    description: "500 credits - tarif abonne (-25%).",
    priceMonthly: 89.99, priceYearly: 89.99, currency: "EUR", credits: 500,
    featured: 0, enabled: 1, sortOrder: 107,
    whopPlanId: "plan_OUFWrPJHvUwxY",
    whopCheckoutUrl: "https://whop.com/checkout/plan_OUFWrPJHvUwxY",
    billingPeriod: "one_time",
    tier: "recharge_subscriber", expiresDays: 30,
  },
];
...
async function doInit(): Promise<void> {
  ...
  try {
    ...
    if (!existingAdmin) {
      ...
      // Phase 1: promote to admin WITHOUT touching credits (avoid CreditLot desync)
      await db.user.update({ where: { id: existingAdmin.id }, data: { role: "ADMIN", updatedAt: new Date() } }).catch(() => {});
      console.log(`[db-init] User promoted to admin: ${adminEmail} (credits left untouched: ${existingAdmin.credits})`);
    } else {
      ...
      if (!existing) {
        ...
        await db.pricingPlan.create({
          data: {
            ...
            expiresDays: (p as any).expiresDays ?? null,
            updatedAt: new Date(),
          },
        ...
        const needsUpdate =
          ...
          ((p as any).tier ?? null) !== (existing as any).tier ||
          ((p as any).expiresDays ?? null) !== (existing as any).expiresDays;
        if (needsUpdate) {
          await db.pricingPlan.update({
            ...
            data: {
              ...
              credits: p.credits,
              description: p.description,
              ...((p as any).tier !== undefined ? { tier: (p as any).tier } : {}),
              ...((p as any).expiresDays !== undefined ? { expiresDays: (p as any).expiresDays } : {}),
              updatedAt: new Date(),
            },
          }).catch(() => {});
